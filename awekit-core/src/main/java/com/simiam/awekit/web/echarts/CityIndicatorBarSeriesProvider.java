...
/**
 * <p>Title: CityIndicatorBarSeriesProvider</p>
 * <p>Description:</p>
 * <p>Copyright: FJ.CMCC Co., Ltd. (c) 2019</p>
 * <p>@Author: chenzhian </p>
 * <p>@Date: 2019/7/2 15:00</p>
 */
public class CityIndicatorBarSeriesProvider extends AbstractBarSeriesProvider {
    ...
    private List<IndicatorModel> modelList;

    private Map<String, IndicatorModel> modelMap;

    public CityIndicatorBarSeriesProvider(boolean isCityLevel, List<IndicatorModel> modelList) {
        this(isCityLevel, true, Constants.FUJIAN, modelList);
    }

    public CityIndicatorBarSeriesProvider(boolean isCityLevel, boolean includeProvince,
            List<IndicatorModel> modelList) {
        this(isCityLevel, includeProvince, Constants.FUJIAN, modelList);
    }

    public CityIndicatorBarSeriesProvider(boolean isCityLevel, boolean includeProvince, String provinceName,
            List<IndicatorModel> modelList) {
        super(modelList);
